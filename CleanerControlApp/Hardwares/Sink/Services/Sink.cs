...
namespace CleanerControlApp.Hardwares.Sink.Services
{
    public class Sink: ISink, IDisposable
    {
        ...
        public bool CanStopAuto => !HS_ShuttleAuto && Sensor_CoverOpen && (HS_InputPermit || HS_ActFinished) && !_pressure && _initialized && (_sim_pass_motor || (MotorServoOn && MotorIdle && MotorHome && InPos1));
